...
public class Style implements Parcelable {
	...
	static {
		...
		addStyle("american-dark-lager", 36, "American Dark Lager");
		...
		addStyle("bohemian-pilsener", 31, "Bohemian Pilsener");
		addStyle("brown-ale", 15, "Brown Ale");
		addStyle("california-common", 42, "California Common");
		addStyle("cider", 10, "Cider");
		addStyle("classic-german-pilsener", 30, "Classic German Pilsener");
